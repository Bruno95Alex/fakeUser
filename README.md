...
O projeto consiste em usar uma API pública para a geração de usúarios fictícios com informações como nome, email, imagem, estado, país, entre outros.
...
A API utilizada foi a https://randomuser.me/ que fornece informações de usúarios através de um JSON conforme abaixo:
